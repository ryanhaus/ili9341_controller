...
set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS33 } [get_ports { spi_ready  }]; #IO_L11N_T1_SRCC_16 Sch=pio[08]
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports { reset  }]; #IO_L6P_T0_16 Sch=pio[09]
set_property -dict { PACKAGE_PIN J3    IOSTANDARD LVCMOS33 } [get_ports { rp_uart_tx }]; #IO_L7P_T1_AD6P_35 Sch=pio[10]
...
set_property -dict { PACKAGE_PIN U3    IOSTANDARD LVCMOS33 } [get_ports { tft_data[0] }]; #IO_L9P_T1_DQS_34 Sch=pio[44]
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33 } [get_ports { tft_data[2] }]; #IO_L19P_T3_34 Sch=pio[45]
set_property -dict { PACKAGE_PIN W7    IOSTANDARD LVCMOS33 } [get_ports { tft_data[4] }]; #IO_L13P_T2_MRCC_34 Sch=pio[46]
