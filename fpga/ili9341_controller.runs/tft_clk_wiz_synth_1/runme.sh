...
HD_PWD='C:/Users/ryanh/Documents/projects/fpga/ili9341_controller/ili9341_controller.runs/tft_clk_wiz_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tft_clk_wiz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tft_clk_wiz.tcl
