...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot tft_clk_wiz xil_defaultlib.tft_clk_wiz xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tft_clk_wiz -key {Behavioral:sim_1:Functional:tft_clk_wiz} -tclbatch cmd.tcl -protoinst "protoinst_files/sim_clk_12mhz.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tft_clk_wiz.wdb xsim.dir libdpi.so)
