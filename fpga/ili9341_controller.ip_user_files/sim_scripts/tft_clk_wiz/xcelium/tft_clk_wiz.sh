...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../ili9341_controller.gen/sources_1/ip/tft_clk_wiz" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../ili9341_controller.gen/sources_1/ip/tft_clk_wiz" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.tft_clk_wiz xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.tft_clk_wiz -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log tft_clk_wiz_sc.so .tmp_log xcelium_lib waves.shm c.obj)
