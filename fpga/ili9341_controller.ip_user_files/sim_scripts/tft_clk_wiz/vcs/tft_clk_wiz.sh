...
#
# Script generated by Vivado on Sun Nov 12 18:57:44 -0500 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : tft_clk_wiz.sh
...
#
# Usage        : tft_clk_wiz.sh
#                tft_clk_wiz.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tft_clk_wiz.sh [-reset_run]
#                tft_clk_wiz.sh [-reset_log]
#                tft_clk_wiz.sh [-help]
#
...
#                script (type 'tft_clk_wiz.sh -help' for more information).
#
...
# script info
echo -e "tft_clk_wiz.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tft_clk_wiz.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../ili9341_controller.gen/sources_1/ip/tft_clk_wiz" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../ili9341_controller.gen/sources_1/ip/tft_clk_wiz" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.tft_clk_wiz xil_defaultlib.glbl -o tft_clk_wiz_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./tft_clk_wiz_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key tft_clk_wiz_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc tft_clk_wiz_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tft_clk_wiz.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tft_clk_wiz.sh [-help]\n\
Usage: tft_clk_wiz.sh [-step]\n\
Usage: tft_clk_wiz.sh [-lib_map_path]\n\
Usage: tft_clk_wiz.sh [-reset_run]\n\
Usage: tft_clk_wiz.sh [-reset_log]\n\
Usage: tft_clk_wiz.sh [-keep_index]\n\
Usage: tft_clk_wiz.sh [-noclean_files]\n\n\
