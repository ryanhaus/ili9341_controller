...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L sim_clk_gen_v1_0_3 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot sim_clk_12mhz xil_defaultlib.sim_clk_12mhz xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim sim_clk_12mhz -key {Behavioral:sim_1:Functional:sim_clk_12mhz} -tclbatch cmd.tcl -protoinst "protoinst_files/sim_clk_12mhz.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sim_clk_12mhz.wdb xsim.dir libdpi.so)
