...
#
# Script generated by Vivado on Sun Nov 12 18:46:22 -0500 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : sim_clk_12mhz.sh
...
#
# Usage        : sim_clk_12mhz.sh
#                sim_clk_12mhz.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sim_clk_12mhz.sh [-reset_run]
#                sim_clk_12mhz.sh [-reset_log]
#                sim_clk_12mhz.sh [-help]
#
...
#                script (type 'sim_clk_12mhz.sh -help' for more information).
#
...
design_libs_elab="-libname sim_clk_gen_v1_0_3 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver sim_clk_gen_v1_0_3 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "sim_clk_12mhz.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sim_clk_12mhz.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.sim_clk_12mhz xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.sim_clk_12mhz -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log sim_clk_12mhz_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./sim_clk_12mhz.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: sim_clk_12mhz.sh [-help]\n\
Usage: sim_clk_12mhz.sh [-step]\n\
Usage: sim_clk_12mhz.sh [-lib_map_path]\n\
Usage: sim_clk_12mhz.sh [-reset_run]\n\
Usage: sim_clk_12mhz.sh [-reset_log]\n\
Usage: sim_clk_12mhz.sh [-keep_index]\n\
Usage: sim_clk_12mhz.sh [-noclean_files]\n\n\
