...
design_libs=(sim_clk_gen_v1_0_3 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.sim_clk_12mhz xil_defaultlib.glbl -o sim_clk_12mhz_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./sim_clk_12mhz_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key sim_clk_12mhz_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc sim_clk_12mhz_simv.daidir vcs_lib c.obj)
